...
namespace Meta.Core
{
    ...
    class ShellCommandController : ApplicationComponent, IShellCommandController
    {

        public ShellCommandController(ILinkedContext C, Func<IEnumerable<N>> NodeProvider)
            : base(C)
        {            
