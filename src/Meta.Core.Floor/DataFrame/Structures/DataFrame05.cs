...
namespace Meta.Core
{
    ...
    public class DataFrame<X1, X2, X3, X4, X5> : DataFrameRoot<DataFrame<X1, X2, X3, X4, X5>>
    {
        ...
        public static implicit operator DataFrame<X1, X2, X3, X4, X5>(Seq<Record<X1, X2, X3, X4, X5>> source)
            => new DataFrame<X1, X2, X3, X4, X5>(source);
        ...
        public DataFrame(IContainer<Record<X1, X2, X3, X4, X5>> rows)            
        ...
        /// <returns></returns>
        public override DataFrame<X1, X2, X3, X4, X5> Construct(IContainer<object[]> data)
            => map(data.AsSeq(), item => Record.make(tupleOf<X1, X2, X3, X4, X5>(item)));
