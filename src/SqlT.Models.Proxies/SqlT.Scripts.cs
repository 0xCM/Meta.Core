//This file was generated at 5/6/2018 7:08:15 PM using version 1.2018.3.31325 the SqT data access toolset.
namespace SqlT.Proxies.Scripts
{
    using SqlT.Types;
    using System;
    ...
    /// <summary>
    /// Routines defined in the SqlT schema
    /// </summary>
    [SqlOperationContract()]
    public partial interface ISqlTOperations
    {
        [SqlProcedure("SqlT", "CopyFile")]
        SqlOutcome<Int32> CopyFile([SqlParameter("@SrcPath", 0, false, false), SqlTypeFacets("nvarchar", true, 4000)] string SrcPath, [SqlParameter("@DstPath", 1, false, false), SqlTypeFacets("nvarchar", true, 4000)] string DstPath);
        [SqlProcedure("SqlT", "StoreTableQueries")]
        SqlOutcome<Int32> StoreTableQueries([SqlParameter("@Tables", 0, true, false), SqlTypeFacets("[SqlT].[TableQuery]", true)] IEnumerable<TableQuery> Tables, [SqlParameter("@Columns", 1, true, false), SqlTypeFacets("[SqlT].[TableQueryColumn]", true)] IEnumerable<TableQueryColumn> Columns, [SqlParameter("@Comparisons", 2, true, false), SqlTypeFacets("[SqlT].[ColumnComparison]", true)] IEnumerable<ColumnComparison> Comparisons);
        [SqlProcedure("SqlT", "CopyFolder")]
        SqlOutcome<Int32> CopyFolder([SqlParameter("@SrcPath", 0, false, false), SqlTypeFacets("nvarchar", true, 4000)] string SrcPath, [SqlParameter("@DstPath", 1, false, false), SqlTypeFacets("nvarchar", true, 4000)] string DstPath);
        [SqlProcedure("SqlT", "SyncForeignKeys")]
        SqlOutcome<Int32> SyncForeignKeys([SqlParameter("@ServerName", 0, false, false), SqlTypeFacets("sysname", true)] string ServerName, [SqlParameter("@DatabaseName", 1, false, false), SqlTypeFacets("sysname", true)] string DatabaseName, [SqlParameter("@ForeignKeys", 2, true, false), SqlTypeFacets("[SqlT].[ForeignKeyInfo]", true)] IEnumerable<ForeignKeyInfo> ForeignKeys);
        [SqlProcedure("SqlT", "HttpPost")]
        SqlOutcome<Int32> HttpPost([SqlParameter("@url", 0, false, false), SqlTypeFacets("nvarchar", true, 500)] string url, [SqlParameter("@json", 1, false, false), SqlTypeFacets("nvarchar", true, 0)] string json);
        [SqlProcedure("SqlT", "SyncTables")]
        SqlOutcome<Int32> SyncTables([SqlParameter("@ServerName", 0, false, false), SqlTypeFacets("nvarchar", true, 128)] string ServerName, [SqlParameter("@DatabaseName", 1, false, false), SqlTypeFacets("nvarchar", true, 128)] string DatabaseName, [SqlParameter("@Tables", 2, true, false), SqlTypeFacets("[SqlT].[TableDescription]", true)] IEnumerable<TableDescription> Tables, [SqlParameter("@Columns", 3, true, false), SqlTypeFacets("[SqlT].[TableColumn]", true)] IEnumerable<TableColumn> Columns);
        [SqlProcedure("SqlT", "WriteTextToFile")]
        SqlOutcome<Int32> WriteTextToFile([SqlParameter("@SrcText", 0, false, false), SqlTypeFacets("nvarchar", true, 0)] string SrcText, [SqlParameter("@DstPath", 1, false, false), SqlTypeFacets("nvarchar", true, 500)] string DstPath);
        [SqlProcedure("SqlT", "SetVar")]
        SqlOutcome<Int32> SetVar([SqlParameter("@VarName", 0, false, false), SqlTypeFacets("nvarchar", true, 250)] string VarName, [SqlParameter("@VarValue", 1, false, false), SqlTypeFacets("nvarchar", true, 4000)] string VarValue);
        [SqlProcedure("SqlT", "SyncDatabases")]
        SqlOutcome<Int32> SyncDatabases([SqlParameter("@ServerName", 0, false, false), SqlTypeFacets("nvarchar", true, 128)] string ServerName, [SqlParameter("@Databases", 1, true, false), SqlTypeFacets("[SqlT].[Database]", true)] IEnumerable<Database> Databases);
        [SqlProcedure("SqlT", "SyncSqlProxyDefinitions")]
        SqlOutcome<Int32> SyncSqlProxyDefinitions([SqlParameter("@Specs", 0, true, false), SqlTypeFacets("[SqlT].[ProxyProfileDefinition]", true)] IEnumerable<ProxyProfileDefinition> Specs);
        [SqlProcedure("SqlT", "StoreBackupDescriptions")]
        SqlOutcome<Int32> StoreBackupDescriptions([SqlParameter("@HostName", 0, false, false), SqlTypeFacets("nvarchar", true, 75)] string HostName, [SqlParameter("@HostPath", 1, false, false), SqlTypeFacets("nvarchar", true, 500)] string HostPath, [SqlParameter("@Descriptions", 2, true, false), SqlTypeFacets("[SqlT].[BackupDescription]", true)] IEnumerable<BackupDescription> Descriptions);
        [SqlProcedure("SqlT", "SynColumnGroupMemberships")]
        SqlOutcome<Int32> SynColumnGroupMemberships([SqlParameter("@ServerName", 0, false, false), SqlTypeFacets("sysname", true)] string ServerName, [SqlParameter("@DatabaseName", 1, false, false), SqlTypeFacets("sysname", true)] string DatabaseName, [SqlParameter("@Assignments", 2, true, false), SqlTypeFacets("[SqlT].[ColumnGroupMember]", true)] IEnumerable<ColumnGroupMember> Assignments);
        [SqlProcedure("SqlT", "StoreNativeTypes")]
        SqlOutcome<Int32> StoreNativeTypes();
        [SqlProcedure("SqlT", "StoreDataTypeDescriptions")]
        SqlOutcome<Int32> StoreDataTypeDescriptions([SqlParameter("@Descriptions", 0, true, false), SqlTypeFacets("[SqlT].[DataTypeDescription]", true)] IEnumerable<DataTypeDescription> Descriptions);
        /// <summary>
        /// Specifies and applies a server-level setting
        /// </summary>
        [SqlProcedure("SqlT", "ConfigureServer")]
        SqlOutcome<Int32> ConfigureServer([SqlParameter("@SettingName", 0, false, false), SqlTypeFacets("varchar", true, 35)] string SettingName, [SqlParameter("@SettingValue", 1, false, false), SqlTypeFacets("int", true)] int? SettingValue);
        [SqlProcedure("SqlT", "ConfigureServerOption")]
        SqlOutcome<Int32> ConfigureServerOption([SqlParameter("@OptionName", 0, false, false), SqlTypeFacets("varchar", true, 35)] string OptionName, [SqlParameter("@OptionValue", 1, false, false), SqlTypeFacets("int", true)] int? OptionValue);
        [SqlProcedure("SqlT", "CreateLinkedServer")]
        SqlOutcome<Int32> CreateLinkedServer([SqlParameter("@Alias", 0, false, false), SqlTypeFacets("nvarchar", true, 128)] string Alias, [SqlParameter("@HostName", 1, false, false), SqlTypeFacets("nvarchar", true, 128)] string HostName, [SqlParameter("@User", 2, false, false), SqlTypeFacets("nvarchar", true, 128)] string User, [SqlParameter("@Password", 3, false, false), SqlTypeFacets("nvarchar", true, 128)] string Password);
        [SqlProcedure("SqlT", "DescribeBackup")]
        SqlOutcome<IReadOnlyList<BackupDescription>> DescribeBackup([SqlParameter("@BackupPath", 0, false, false), SqlTypeFacets("nvarchar", true, 256)] string BackupPath);
        [SqlProcedure("SqlT", "DropDatabase")]
        SqlOutcome<Int32> DropDatabase([SqlParameter("@DbName", 0, false, false), SqlTypeFacets("sysname", true)] string DbName);
        [SqlProcedure("SqlT", "EnabledContainedDatabases")]
        SqlOutcome<Int32> EnabledContainedDatabases();
        [SqlProcedure("SqlT", "EnableSqlClr")]
        SqlOutcome<Int32> EnableSqlClr();
        [SqlProcedure("SqlT", "EnableStatisticsProfiling")]
        SqlOutcome<Int32> EnableStatisticsProfiling();
        [SqlProcedure("SqlT", "EnableXpCmdShell")]
        SqlOutcome<Int32> EnableXpCmdShell();
        [SqlProcedure("SqlT", "ExportQueryData")]
        SqlOutcome<Int32> ExportQueryData([SqlParameter("@Query", 0, false, false), SqlTypeFacets("nvarchar", true, 500)] string Query, [SqlParameter("@DstFile", 1, false, false), SqlTypeFacets("nvarchar", true, 500)] string DstFile);
        [SqlProcedure("SqlT", "ExportTableData")]
        SqlOutcome<Int32> ExportTableData([SqlParameter("@TableSchema", 0, false, false), SqlTypeFacets("sysname", true)] string TableSchema, [SqlParameter("@TableName", 1, false, false), SqlTypeFacets("sysname", true)] string TableName, [SqlParameter("@DstFile", 2, false, false), SqlTypeFacets("nvarchar", true, 500)] string DstFile);
        /// <summary>
        /// Retrieves descriptions for the files that match with the supplied state and file type
        /// </summary>
        [SqlProcedure("SqlT", "GetFileDescriptions")]
        SqlOutcome<Int32> GetFileDescriptions([SqlParameter("@FileState", 0, false, false), SqlTypeFacets("nvarchar", true, 50)] string FileState, [SqlParameter("@FileType", 1, false, false), SqlTypeFacets("nvarchar", true, 50)] string FileType);
        [SqlProcedure("SqlT", "GetServerPathDefaults")]
        SqlOutcome<IReadOnlyList<DefaultFilePath>> GetServerPathDefaults();
        [SqlProcedure("SqlT", "GoOffline")]
        SqlOutcome<Int32> GoOffline([SqlParameter("@DbName", 0, false, false), SqlTypeFacets("sysname", true)] string DbName);
        [SqlProcedure("SqlT", "GoOnline")]
        SqlOutcome<Int32> GoOnline([SqlParameter("@DbName", 0, false, false), SqlTypeFacets("sysname", true)] string DbName);
        [SqlProcedure("SqlT", "RestoreBackup")]
        SqlOutcome<Int32> RestoreBackup([SqlParameter("@BackupName", 0, false, false), SqlTypeFacets("nvarchar", true, 128)] string BackupName, [SqlParameter("@BackupFolder", 1, false, false), SqlTypeFacets("nvarchar", true, 500)] string BackupFolder, [SqlParameter("@DataFolder", 2, false, false), SqlTypeFacets("nvarchar", true, 500)] string DataFolder);
        [SqlProcedure("SqlT", "SyncColumnRoleTypes")]
        SqlOutcome<Int32> SyncColumnRoleTypes([SqlParameter("@Roles", 0, true, false), SqlTypeFacets("[SqlT].[LargeTypeTable]", true)] IEnumerable<LargeTypeTable> Roles);
        [SqlProcedure("SqlT", "SynColumnRoleAssignments")]
        SqlOutcome<Int32> SynColumnRoleAssignments([SqlParameter("@ServerName", 0, false, false), SqlTypeFacets("sysname", true)] string ServerName, [SqlParameter("@DatabaseName", 1, false, false), SqlTypeFacets("sysname", true)] string DatabaseName, [SqlParameter("@Assignments", 2, true, false), SqlTypeFacets("[SqlT].[ColumnRoleAssignment]", true)] IEnumerable<ColumnRoleAssignment> Assignments);
        [SqlTableFunction("SqlT", "SqlProxyDefinitions")]
        SqlOutcome<IReadOnlyList<ProxyProfileDefinition>> SqlProxyDefinitions();
        [SqlTableFunction("SqlT", "SqlProxyDefinitionsByDatabase")]
        SqlOutcome<IReadOnlyList<ProxyProfileDefinition>> SqlProxyDefinitionsByDatabase([SqlParameter("@DbName", 0, false, false), SqlTypeFacets("nvarchar", true, 128)] string DbName);
        [SqlTableFunction("SqlT", "FindSqlProxyDefinition")]
        SqlOutcome<IReadOnlyList<ProxyProfileDefinition>> FindSqlProxyDefinition([SqlParameter("@ProfileName", 0, false, false), SqlTypeFacets("nvarchar", true, 75)] string ProfileName);
        [SqlTableFunction("SqlT", "Dir")]
        SqlOutcome<IReadOnlyList<DirResult>> Dir([SqlParameter("@SrcPath", 0, false, false), SqlTypeFacets("nvarchar", true, 4000)] string SrcPath, [SqlParameter("@Filter", 1, false, false), SqlTypeFacets("nvarchar", true, 250)] string Filter);
        [SqlTableFunction("SqlT", "Drives")]
        SqlOutcome<IReadOnlyList<DrivesResult>> Drives();
        [SqlTableFunction("SqlT", "NodeVars")]
        SqlOutcome<IReadOnlyList<NodeVarsResult>> NodeVars();
        [SqlTableFunction("SqlT", "DescribeDataTypes")]
        SqlOutcome<IReadOnlyList<DataTypeDescription>> DescribeDataTypes();
        [SqlTableFunction("SqlT", "DescribeFileTables")]
        SqlOutcome<IReadOnlyList<FileTableDescription>> DescribeFileTables();
        [SqlTableFunction("SqlT", "DescribeForeignKeys")]
        SqlOutcome<IReadOnlyList<ForeignKeyInfo>> DescribeForeignKeys();
        [SqlTableFunction("SqlT", "DescribeSchemaIndexes")]
        SqlOutcome<IReadOnlyList<DescribeSchemaIndexesResult>> DescribeSchemaIndexes([SqlParameter("@SchemaName", 0, false, false), SqlTypeFacets("sysname", true)] string SchemaName);
        [SqlTableFunction("SqlT", "DescribeTableColumns")]
        SqlOutcome<IReadOnlyList<DescribeTableColumnsResult>> DescribeTableColumns();
        [SqlTableFunction("SqlT", "GenerateColumnDropSql")]
        SqlOutcome<IReadOnlyList<GenerateColumnDropSqlResult>> GenerateColumnDropSql([SqlParameter("@ColumnName", 0, false, false), SqlTypeFacets("sysname", true)] string ColumnName);
        [SqlTableFunction("SqlT", "GetCpuUsage")]
        SqlOutcome<IReadOnlyList<GetCpuUsageResult>> GetCpuUsage();
        [SqlTableFunction("SqlT", "GetIndexCreationProgress")]
        SqlOutcome<IReadOnlyList<GetIndexCreationProgressResult>> GetIndexCreationProgress([SqlParameter("@SessionId", 0, false, false), SqlTypeFacets("int", true)] int? SessionId);
        [SqlTableFunction("SqlT", "GetIndexStatsUpdate")]
        SqlOutcome<IReadOnlyList<GetIndexStatsUpdateResult>> GetIndexStatsUpdate();
        [SqlTableFunction("SqlT", "GetIndexStorageCost")]
        SqlOutcome<IReadOnlyList<GetIndexStorageCostResult>> GetIndexStorageCost();
        [SqlTableFunction("SqlT", "GetObjectDefinitions")]
        SqlOutcome<IReadOnlyList<GetObjectDefinitionsResult>> GetObjectDefinitions();
        [SqlTableFunction("SqlT", "GetRunningQueries")]
        SqlOutcome<IReadOnlyList<GetRunningQueriesResult>> GetRunningQueries();
        [SqlTableFunction("SqlT", "GetServerCollations")]
        SqlOutcome<IReadOnlyList<ServerCollation>> GetServerCollations();
        [SqlTableFunction("SqlT", "GetSystemSummary")]
        SqlOutcome<IReadOnlyList<GetSystemSummaryResult>> GetSystemSummary();
        [SqlTableFunction("SqlT", "GetTableIndexFragmentation")]
        SqlOutcome<IReadOnlyList<GetTableIndexFragmentationResult>> GetTableIndexFragmentation([SqlParameter("@TableSchema", 0, false, false), SqlTypeFacets("sysname", true)] string TableSchema, [SqlParameter("@TableName", 1, false, false), SqlTypeFacets("sysname", true)] string TableName);
        [SqlTableFunction("SqlT", "ObjectExists")]
        SqlOutcome<IReadOnlyList<ObjectExistsResult>> ObjectExists([SqlParameter("@ObjectName", 0, false, false), SqlTypeFacets("nvarchar", true, 260)] string ObjectName);
    }
}
// Emission concluded at 5/6/2018 7:08:16 PM
