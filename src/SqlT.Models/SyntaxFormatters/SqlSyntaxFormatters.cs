...
namespace SqlT.Syntax
{
    ...
    public static class SqlSyntaxFormatters
    {
        ...
        public static string FormatSyntax(this SqlVariableDeclaration m)
            => concat($"{DECLARE} {m.VariableName}", " ", 
                $"{m.Initializer.MapValueOrDefault(s => s.FormatSyntax(), string.Empty)}");
