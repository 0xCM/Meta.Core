...
public static class CollectionExtensions
{
    ...
    /// <param name="values"></param>
    /// <returns></returns>
    public static Option<TValue> TryGetSingle<TValue>(this IEnumerable<TValue> values, Func<TValue, bool> predicate)
    {
        var satisfied = values.Where(predicate).ToList();
        if (satisfied.Count == 0)
            return Option.None<TValue>(SequencePredicateUnsatisfied());
        else if (satisfied.Count > 1)
            return Option.None<TValue>(MoreThanOneSequencePredicate());
        else
    ...
    /// <returns></returns>
    public static G.ISet<T> ToSet<T>(this IEnumerable<T> items)
        => new HashSet<T>(items);
    ...
    public static void AddRange<T>(this G.IList<T> list, IEnumerable<T> items)
    ...
    /// <param name="items">The item sequence</param>
    /// <returns></returns>
    public static G.ISet<U> ToSet<T, U>(this IEnumerable<T> items, Func<T, U> selector)
    ...
    /// <param name="items">The items to add</param>
    public static void AddRange<T>(this G.ISet<T> set, IEnumerable<T> items)
    ...
    /// <returns></returns>
    public static bool IsEmpty<T>(this G.ISet<T> set)
        => set.Count == 0;
    ...
    /// <param name="set">The set under examination</param>
    /// <returns></returns>
    public static bool IsNonEmpty<T>(this G.ISet<T> set)
        => set.Count != 0;
    /// <summary>
    ...
    /// <returns></returns>
    public static G.ISet<T> Union<T>(this G.ISet<T> set, IEnumerable<T> items)
    ...
    /// <returns></returns>
    public static G.ISet<T> Intersect<T>(this G.ISet<T> set, IEnumerable<T> stream)
