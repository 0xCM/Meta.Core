...
/// </summary>
public sealed class ApplicationMessageState
{

    public static readonly ApplicationMessageState Empty = new ApplicationMessageState(true);

    ApplicationMessageState(bool Empty)
    {
    ...
    public ApplicationMessageState()
        : this(true)
    {
