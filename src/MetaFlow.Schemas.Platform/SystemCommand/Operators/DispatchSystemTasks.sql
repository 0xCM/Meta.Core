create procedure [WF].[DispatchSystemTasks](@MaxCount int = 10) as
	...
	declare 
		...
		@LoadCT int = 0,
		@OpName nvarchar(250) = '[WF].[DispatchSystemTasks]',
		@Msg nvarchar(250);

	set @Msg = concat('Executing @OpName=', @OpName, ' @MaxCount=', @MaxCount);	
...
exec sp_addextendedproperty @name = N'DM_RecordType',
    ...
    @level1name = N'DispatchSystemTasks'
GO
